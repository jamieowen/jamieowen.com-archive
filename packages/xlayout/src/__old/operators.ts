 ...
 */
export const set = (name: string, rfn: AttributeOpRfn) =>
  setAttribute(name, rfn);
export const scale = (name: string, rfn: AttributeOpRfn) =>
  setAttribute(name, (i, x, n) => {
...
export const offset = (name: string, rfn: AttributeOpRfn) =>
  setAttribute(name, (i, x, n) => {
...
export const fromSeed = (name: string) =>
  setAttribute(name, (i, x, n) => {
