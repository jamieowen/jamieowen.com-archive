...
export const positionScale = ( rfn:OpRfn ) => mapIndexed((i:number,n:Node)=>{
...
export const rotate = ( rfn:OpRfn ) => mapIndexed((i:number,n:Node)=>{
...
export const branch = (rfn:OpRfn) => mapIndexed( (i,n:Node)=>{
...
export const branch2 = (rfn:OpRfn) => mapIndexed( (i,context:XLayout)=>{
...
export const sizeToBounds = ( rfn:OpRfn=()=>{} ) => mapIndexed((i:number,n:Node)=>{
  ...
  if( n.parent instanceof BoundsNode ){
    ...
    if( n instanceof CircleNode ){
      (<CircleNode>n).radius = Math.min(bn.bounds[0],bn.bounds[1])*0.5*factor;
    }
...
export const centerToBounds = ( rfn:OpRfn=()=>{} ) => mapIndexed((i:number,n:Node)=>{
