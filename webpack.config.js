      ...
      return {
        ...
        resolve: {
          alias: {
            ...
            "@jamieowen/three-mesh-instancing": path.resolve(
              __dirname,
              "packages/three-mesh-instancing"
            ),
            "@jamieowen/three-transform-geometry": path.resolve(
              __dirname,
              "packages/three-transform-geometry"
            ),
            "@jamieowen/three-renderman": path.resolve(
              __dirname,
              "packages/three-renderman/src"
            ),
            "@jamieowen/toy.gui": path.resolve(__dirname, "packages/toy-ui"),
            "@jamieowen/three-drawcontext": path.resolve(
              __dirname,
              "packages/three-drawcontext"
            ),
            "@jamieowen/three-toolkit": path.resolve(
              __dirname,
